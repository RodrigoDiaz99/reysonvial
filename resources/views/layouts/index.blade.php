...
<body id="page-top">
  ...
  <nav class="navbar navbar-expand-lg navbar-dark fixed-top" id="mainNav">
    <div class="container">
      <a class="navbar-brand js-scroll-trigger" href="#page-top">ReysonVial</a>
  ...
  <header class="masthead">
    <div class="container">
      <div class="intro-text">
        <div class="intro-lead-in">Bienvenid@ a nuestra página!</div>
        <div class="intro-heading text-uppercase">Es un gusto conocerte</div>
    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-12 text-center">
          ...
          <h3 class="section-subheading text-muted">Estos son los servicios que proporcionamos.</h3>
        </div>
      </div>
    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-12 text-center">
          ...
          <h3 class="section-subheading text-muted">Conoce al equipo que desarrollo este trabajo.</h3>
        </div>
      </div>
      <div class="row">
        <div class="col-sm-4">
    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-12 text-center">
          ...
          <h3 class="section-subheading text-muted">Si tiene alguna queja, sugerencia no dude enviarnos un correo.</h3>
        </div>
      </div>
      <div class="row">
        <div class="col-lg-12">
  ...
  <footer class="footer">
    <div class="container">
      <div class="row align-items-center">
        <div class="col-md-4">
          <span class="copyright">Copyright &copy; ReysonVial 2020</span>
        </div>
        <div class="col-md-4">
          <ul class="list-inline social-buttons">
            <li class="list-inline-item">
